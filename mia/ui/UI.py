...
class MainWindow(object):
    def setupUi(self, Form):
        ...
        self.RBPoints = QRadioButton('Points', self.centralWidget)
        self.RBLines = QRadioButton('Lines', self.centralWidget)
        self.RBPoints.setToolTip('Select to detect objects as points')
        self.RBLines.setToolTip('Select to detect lines')
        
        self.DetectionSettingslayout.addWidget(self.RBPoints)
        self.DetectionSettingslayout.addWidget(self.RBLines)
        ...
        #draw line tool
        self.Bdrawline = DCDButton(self.centralWidget)
        self.Bdrawline.setMaximumSize(bwidth, bheight)
        self.Bdrawline.setVisible(False)
        self.Bdrawline.setObjectName('drawline')
        self.Bdrawline.setToolTip('Select draw line tool')
        self.Bdrawline.setIcon(QIcon('icons/draw.png'))
        #draw tool
        ...
        # polyline tool
        self.Bpolyline = DCDButton(self.centralWidget)
        self.Bpolyline.setMaximumSize(bwidth, bheight)
        self.Bpolyline.setVisible(False)
        self.Bpolyline.setObjectName('polyline')
        self.Bpolyline.setToolTip('Select polyline tool')
        self.Bpolyline.setIcon(QIcon('icons/poly.png'))
        # polygon tool
        ...
        # erase tool
        self.Berase = DCDButton(self.centralWidget)
        self.Berase.setMaximumSize(bwidth, bheight)
        self.Berase.setVisible(False)
        self.Berase.setObjectName('erase')
        self.Berase.setToolTip('Select erase tool')
        self.Berase.setIcon(QIcon('icons/expand.png'))
        # extend tool
        ...
        self.ToolButtonslayout.addWidget(self.Bdrawline)
        self.ToolButtonslayout.addWidget(self.Bdraw)
        self.ToolButtonslayout.addWidget(self.BsetObject)
        self.ToolButtonslayout.addWidget(self.Bpolyline)
        ...
        self.ToolButtonslayout.addWidget(self.Berase)
