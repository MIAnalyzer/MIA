...
class Window(object):
    def setupUi(self, Form):
        ...
        self.CBModel.setObjectName('Model')
    ...
    def ParameterGroup(self):
        ...
        self.SBClasses.setObjectName('NumOfClasses')
        ...
        self.CBMono.setObjectName('MonochromaticInput')
        ...
        self.CBRGB.setObjectName('RGBInput')
        ...
        self.SBBatchSize.setObjectName('BatchSize')
        ...
        self.SBEpochs.setObjectName('Epochs')
        ...
        self.SBScaleFactor.setObjectName('ImageDownScaling')
